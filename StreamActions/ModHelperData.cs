...
public static class ModHelperData
{
    ...
    internal const string Description = "A mod to interact with viewers in chat. It gives you 4 random actions that will happen every 30-60 seconds, which people vote on by typing a number from 1-4, corresponding to the action. The mod should be mosty stable but it is hard to test, keep in mind there may be bugs. If you find any, please report them on the GitHub page alongside a log.";
